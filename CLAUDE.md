...
- Default config: `.foundationModels` provider (Apple Intelligence); recommended local models via `ModelRecommendation` (Qwen 3.5 series); `.custom` provider uses `http://localhost:1234/v1` (LM Studio)

...
struct LLMConfigTests {
    ...
    private static let suiteName = "com.transcribenote.test.LLMConfigTests"
    ...
    @Test func keychainKeyForKnownKeys() {
        ...
        #expect(LLMConfig.keychainKey(for: "titleLLMConfigJSON") == "transcribenote.title.apiKey")
        #expect(LLMConfig.keychainKey(for: "llmConfigJSON") == "transcribenote.legacy.apiKey")
    }

    @Test func keychainKeyForUnknownKey() {
        #expect(LLMConfig.keychainKey(for: "myCustomKey") == "transcribenote.myCustomKey.apiKey")
    }

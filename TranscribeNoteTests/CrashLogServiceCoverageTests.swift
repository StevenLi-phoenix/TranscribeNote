...
struct CrashLogServiceCoverageTests {
    ...
    private var crashLogDirectory: URL {
        ...
        return appSupport.appendingPathComponent("TranscribeNote/CrashLogs", isDirectory: true)
    }
    ...
    @Test("crashLogDirectory lives under Application Support/TranscribeNote/CrashLogs")
    func crashLogDirectoryPath() {
        let path = crashLogDirectory.path
        #expect(path.contains("Application Support/TranscribeNote/CrashLogs"))
    }

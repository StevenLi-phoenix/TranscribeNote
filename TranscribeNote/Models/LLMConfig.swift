...
extension Notification.Name {
    static let llmConfigDidSave = Notification.Name("transcribenote.llmConfigDidSave")
    static let summarizerConfigDidSave = Notification.Name("transcribenote.summarizerConfigDidSave")
}
...
nonisolated struct LLMConfig: Codable, Sendable, Equatable {
    ...
    static func keychainKey(for configKey: String) -> String {
        switch configKey {
        case "liveLLMConfigJSON": return "transcribenote.live.apiKey"
        case "overallLLMConfigJSON": return "transcribenote.overall.apiKey"
        case "titleLLMConfigJSON": return "transcribenote.title.apiKey"
        case "llmConfigJSON": return "transcribenote.legacy.apiKey"
        default: return "transcribenote.\(configKey).apiKey"
        }
    }
    ...
    static func save(_ config: LLMConfig, to key: String, defaults: UserDefaults = .standard) {
        let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "LLMConfig")

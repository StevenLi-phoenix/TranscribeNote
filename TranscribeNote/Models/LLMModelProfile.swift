...
nonisolated struct LLMModelProfile: Codable, Identifiable, Sendable, Equatable {
    ...
    var keychainKey: String { "transcribenote.profile.\(id.uuidString).apiKey" }
}
...
enum LLMProfileStore {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "LLMProfileStore")

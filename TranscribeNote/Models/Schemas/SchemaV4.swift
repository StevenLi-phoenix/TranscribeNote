...
/// SchemaV4 - Adds `audioFilePaths` to RecordingSession for multi-clip pause/resume support.
enum SchemaV4: VersionedSchema {
    static var versionIdentifier = Schema.Version(4, 0, 0)

    static var models: [any PersistentModel.Type] {
        [
            SchemaV4.RecordingSession.self,
            SchemaV4.TranscriptSegment.self,
            SchemaV4.SummaryBlock.self,
            SchemaV4.ScheduledRecording.self,
        ]
    }

    // MARK: - RecordingSession (modified: added audioFilePaths)
    ...
    final class TranscriptSegment {
        ...
        @Relationship(inverse: \SchemaV4.RecordingSession.segments)
        var session: SchemaV4.RecordingSession?
    ...
    final class SummaryBlock {
        ...
        @Relationship(inverse: \SchemaV4.RecordingSession.summaries)
        var session: SchemaV4.RecordingSession?

...
struct ContentView: View {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "ContentView")
            ...
            SessionListView(selectedSessionID: $selectedSessionID)
                ...
                .toolbar {
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        .accessibilityLabel(String(localized: "Scheduled recordings"))
                    }
                }
    ...
    private func buildPaletteCommands() -> [PaletteCommand] {
        ...
        if viewModel.isActive {
            commands.append(PaletteCommand(
                ...
                subtitle: String(localized: "End the current recording session"),
                icon: "stop.fill",
                shortcut: nil,
                category: .recording,
            ...
            commands.append(PaletteCommand(
                ...
                subtitle: String(localized: "Begin a new recording session"),
                icon: "record.circle",
                shortcut: "⌘N",
                category: .recording,
                action: { [viewModel, modelContext] in
        ...
        commands.append(PaletteCommand(
            ...
            subtitle: String(localized: "Open this command palette"),
            icon: "command",
            shortcut: "⌘K",
            category: .navigation,
            action: {} // Already open
        ...
        commands.append(PaletteCommand(
            ...
            title: String(localized: "Scheduled Recordings"),
            subtitle: String(localized: "View and manage scheduled recordings"),
        ...
        commands.append(PaletteCommand(
            ...
            subtitle: String(localized: "Toggle audio playback"),
        ...
        commands.append(PaletteCommand(
            id: "seek-forward",
            title: String(localized: "Skip Forward 5s"),
            subtitle: nil,
            icon: "goforward.5",
            shortcut: "→",
            category: .playback,
        ...
        commands.append(PaletteCommand(
            id: "seek-backward",
            title: String(localized: "Skip Back 5s"),
            subtitle: nil,
            icon: "gobackward.5",
            shortcut: "←",
            category: .playback,
        ...
        commands.append(PaletteCommand(
            ...
            title: String(localized: "Skip Forward 15s"),
            subtitle: nil,
            icon: "goforward.15",
            shortcut: "⇧→",
            category: .playback,
        ...
        commands.append(PaletteCommand(
            ...
            title: String(localized: "Skip Back 15s"),
            subtitle: nil,
            icon: "gobackward.15",
            shortcut: "⇧←",
            category: .playback,
        ...
        commands.append(PaletteCommand(
            ...
            subtitle: String(localized: "Export session as Markdown file"),
            icon: "doc.text",
            shortcut: "⌘E",
            category: .export,
            action: {

...
nonisolated func executeToolLoop(
    ...
    let logger = Logger(subsystem: "com.transcribenote", category: "ToolLoop")
...
nonisolated enum LLMHTTPHelpers {
    ...
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "LLMHTTPHelpers")

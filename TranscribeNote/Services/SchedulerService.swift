...
extension Notification.Name {
    static let scheduledRecordingDidFire = Notification.Name("transcribenote.scheduledRecordingDidFire")
}
...
nonisolated final class SchedulerService: NSObject, SchedulerServiceProtocol, UNUserNotificationCenterDelegate, @unchecked Sendable {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "Scheduler")

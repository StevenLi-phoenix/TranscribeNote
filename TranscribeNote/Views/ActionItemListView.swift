...
struct ActionItemListView: View {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "ActionItemListView")
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack {
                ...
                .accessibilityLabel(String(localized: "Export action items"))

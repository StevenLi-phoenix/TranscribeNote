...
struct SummaryCardView: View {
    ...
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "SummaryCardView")
            ...
            if !isEditing && !showRegenerateField && (isHovered || showCopiedFeedback) {
                HStack(spacing: DS.Spacing.xs) {
                    ...
                    if onSave != nil {
                        ...
                        .accessibilityLabel(String(localized: "Edit summary"))
                    }
                    if onRegenerate != nil {
                        Button {
                        ...
                        .accessibilityLabel(String(localized: "Regenerate summary"))
                    }
                }
            }
        }
    ...
    private var copyButton: some View {
        ...
        .accessibilityLabel(String(localized: "Copy summary to clipboard"))
    }

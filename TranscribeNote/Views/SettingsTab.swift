...
final class VADTestRunner {
    private static let logger = Logger(subsystem: "com.transcribenote", category: "VADTest")
    ...
    private let writeQueue = DispatchQueue(label: "com.transcribenote.vad-test", qos: .userInitiated)
...
struct VADTestView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: DS.Spacing.xs) {
            ...
            .accessibilityLabel(String(localized: "Microphone level"))

...
struct CommandPaletteView: View {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "CommandPalette")
    ...
    var body: some View {
        ZStack {
            ...
            Color.black.opacity(0.3)
                ...
                .accessibilityLabel(String(localized: "Dismiss command palette"))
            ...
            VStack(spacing: 0) {
                ...
                HStack(spacing: DS.Spacing.sm) {
                    ...
                    TextField("Type a command…", text: $query)
                        ...
                        .accessibilityLabel(String(localized: "Command search"))

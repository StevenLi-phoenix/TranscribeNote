...
struct SessionDetailView: View {
    private static let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "TranscribeNote", category: "SessionDetailView")
    ...
    var body: some View {
        if isLoading {
            ProgressView()
                .accessibilityLabel(String(localized: "Loading session"))
            ...
            VStack(spacing: 0) {
                ...
                .accessibilityLabel(String(localized: "Session view"))
